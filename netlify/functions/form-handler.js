...
exports.handler = async (event) => {
    ...
    try {
      ...
      `,
        ...
        <p>Neste momento, a melhor forma de nos contactares é através do nosso Instagram: 
        <strong>@arj_casa_do_lago</strong>. Podes enviar-nos uma mensagem diretamente lá para conversarmos mais sobre as aulas.</p>
      ...
      `,
            text: `Olá ${name}, obrigado por mostrares interesse em começar aulas connosco! 
A melhor forma de nos contactares é via Instagram (@arj_casa_do_lago) ou através do número +351 913 901 120. 
Esperamos falar contigo em breve!`,
        });
